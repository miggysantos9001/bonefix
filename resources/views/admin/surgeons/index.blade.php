    ...
    <div class="row">
        ...
        <div class="col-3">
            <section class="card">
                ...
                {!! Form::open(['model'=>'POST','action'=>'SurgeonController@store']) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
        ...
        <div class="col-9">
            <section class="card">
                <header class="card-header">
                    <h4 class="card-title">Surgeon List</h4>
                </header>
                <div class="card-body">
                    <section class="card">
                        <div class="card-body">
                            <form class="row gx-3 gy-2 mb-2 align-items-center" method="GET" action="">
                                @csrf
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="searchName" placeholder="Search Surgeon Entry">
                                </div>
                                <div class="col-auto">
                                    <button type="submit" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> Search</button>
                                    <a href="{{ route('surgeons.index') }}" class="btn btn-success btn-xs"><i class="fa fa-retweet"></i> Reset Search</a>
                                </div>
                            </form>
                        </div>
                    </section>
