    ...
    <div class="row">
        ...
        <div class="col-3">
            <section class="card">
                ...
                {!! Form::open(['model'=>'POST','action'=>'SupplierController@store']) !!}
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="form-group">
                                {!! Form::label('Contact #') !!}
                                {!! Form::text('contact',null,['class'=>'form-control form-control-sm']) !!}
                            </div>
                            <div class="form-group">
                    ...
                    <section class="card">
                        <div class="card-body">
                            <form class="row gx-3 gy-2 mb-2 align-items-center" method="GET" action="">
                                @csrf
                                <div class="col-sm-9">
                                    <input type="text" class="form-control form-control-sm" name="searchName" placeholder="Search Supplier Entry">
                                </div>
                                <div class="col-auto">
                                    <button type="submit" class="btn btn-primary btn-xs"><i class="fa fa-search"></i> Search</button>
                                    <a href="{{ route('suppliers.index') }}" class="btn btn-success btn-xs"><i class="fa fa-retweet"></i> Reset Search</a>
                                </div>
                            </form>
                        </div>
                    </section>
                    <table class="table table-sm table-condensed table-no-more" style="text-transform:uppercase;font-size:12px;">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td data-title="Email" class="">{{ $d->email }}</td>
                                <td data-title="Contact #" class="">{{ $d->contact }}</td>
            ...
            <div class="modal-body">
                <div class="row mb-3">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            {!! Form::label('Contact #') !!}
                            {!! Form::text('contact',$d->contact,['class'=>'form-control form-control-sm']) !!}
                        </div>
                        <div class="form-group">
                            {!! Form::label('Contact Person') !!}
